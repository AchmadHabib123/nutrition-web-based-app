<x-app-layout>
    ...
    <form action="{{ route('ahli-gizi.logistics.bahan_makanans.import') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form action="{{ route('ahli-gizi.logistics.bahan_makanans.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="stok" class="block text-gray-700">Stok (jumlah unit/bahan)</label>
                        <input type="number" name="stok" id="stok" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" required>
                    </div>                    
                    <div class="mt-6">
