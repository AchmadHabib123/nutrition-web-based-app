<x-app-layout>
    ...
    <form action="{{ route('admin.bahan_makanans.import') }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form action="{{ route('admin.bahan_makanans.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
